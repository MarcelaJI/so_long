...
SO_LONG_SRC_DIR = ./src
SO_LONG_SRC = so_long.c map_parse.c print_error.c free.c g_utils.c map_parse_2.c map_parse_3.c game.c asset_manager.c asset_manager_2.c render.c render_2.c events.c dragon.c dragon_2.c
